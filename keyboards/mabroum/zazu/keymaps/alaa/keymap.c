...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_2_3x5_3(
        ...
        OS_LCTL, OS_LCTL,  OS_LALT, OS_LGUI,  OS_LSFT, SALL,              KC_DOT,  KC_LEFT,   KC_DOWN,  KC_RIGHT, WRKFLW2,  WRKFLW2,
                 KC_6,  CUT,     CPY,      PST,        SALL,              KC_0,    KC_ENT,    KC_BSPC,  KC_TAB,   KC_6,
    ...
    [SYM] = LAYOUT_2_3x5_3(
        ...
        KC_2,     KC_3,   KC_2,   KC_1,   KC_0,   KC_MINUS,           KC_DOT,   OS_LSFT, OS_LGUI,  OS_RALT, OS_RALT, OS_LCTL,
    ...
    [NAVW] = LAYOUT_2_3x5_3(
        SCRNSHT, SCRNSHT,  KC_ENT, KC_BSPC, KC_TAB,  KC_DEL,            DWRD,    KC_F2,     KC_UP,    QUITW,    DPI_MOD,   DPI_MOD,
        OS_LGUI, OS_LGUI,  OS_LALT, OS_LCTL, OS_LSFT, SALLW,            SALLW,   KC_LEFT,   KC_DOWN,  KC_RIGHT, RCRD,   RCRD,
                 KC_6,     CUTW,   CPYW,    PSTW,    SALLW,              KC_0,         KC_ENT,    KC_BSPC,  KC_TAB,   KC_6,
                                          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,
                                          KC_TRNS, KC_TRNS, KC_TRNS,
                                         // click  ,  right , down      , left   , up
                                            KC_TRNS, KC_TRNS, DPI_RMOD, KC_TRNS, DPI_MOD
    ...
    [SYMW] = LAYOUT_2_3x5_3(
        ...
        KC_3,     KC_3,  KC_2,   KC_1,   KC_0,   KC_MINUS,           KC_DOT,   OS_LSFT, OS_LCTL, OS_RALT, KC_2, OS_LGUI,
                  KC_6,  KC_6,   KC_5,   KC_4,   KC_0,               KC_0,     KC_QUES, KC_EXLM, KC_SLSH, KC_6,
                                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,
                                            RGB_HUD, RGB_SAI, RGB_SAD,
                                         // click  ,  right , down      , left   , up
